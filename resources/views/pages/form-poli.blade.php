    ...
    <div class="container-signup" style="width:100%">
        <div class="signin-content">
                ...
                <form method="post" action="{{url('doReservasi')}}" class="register-form mt-5" id="login-form">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_dokter" id="dokter_poli" class="form-select">
                            ...
                            <option value="{{ $row->id }}">{{ $row->nama_dokter }} | <label
                                    clsas="fw-bold">{{ $row->nama_poli }}</label> </option>
                            @endforeach
                        </select>
                    </div>
                    <!-- <div class="mb-3">
            ...
            <div class="signin-image">
                <figure><img src="{{asset('assets/images/art2.png')}}" alt="sing up image" class="img-fluid"
                        style="margin-top:50%;margin-right:70px"></figure>
            </div>
        </div>
    </div>
</section>
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    $('#' + name).append('<option value="' + value.id + '">' + value
                        .jadwal_mulai + ' - ' + value.jadwal_selesai + '</option>');
                });
            }
        });
    }
