                  ...
                  <form method="GET" action="{{url('pilih-poli')}}" class="register-form" id="login-form">
                    @csrf
                      <div class="form-group">
                          <label for="no_rekam_medis"><i class="bi bi-file-earmark-medical"></i></label>
                          <input type="text" name="no_rekam_medis" id="no_rekam_medis" placeholder="No Rekam Medis"/>
                      </div>
                      <div class="form-group">
                          <label for="tgl_lahir"><i class="bi bi-calendar"></i></label>
  ...
  <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
    ...
    <div class="card border-0 rounded mt-4">
        <div class="card-body">
          ...
          @csrf
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  <span for="no_rekam_medis" class="form-label">No Rekam Medis</span>
                ...
                <div class="mb-3">
                  <span for="jenis_kelamin" class="form-label">Jenis Kelamin</span>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <span for="no_telp" class="form-label">Nomor Telepon</span>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <span for="alamat" class="form-label">Alamat Lengkap</span>
      ...
      <div class="card border-0 rounded mt-4">
        ...
        <h4 class="mb-4 fw-semibold">Data Wali</h4>
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  <span for="nama_lengkap_wali" class="form-label">Nama Lengkap</span>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <span for="provinsi_wali" class="form-label">Provinsi</span>
                ...
                <div class="mb-3">
                  <span for="kabupaten_kota_wali" class="form-label">Kabupaten/Kota</span>
                ...
                <div class="mb-3">
                  <span for="kecamatan_wali" class="form-label">Kecamatan</span>
      ...
      <div class="card border-0 mt-4">
        <div class="card-body">
          <div class="mb-3">
            <span for="metode_bayar" class="form-label">Metode Pembayaran</span>
          ...
          <h4 class="fw-semibold mb-4">Unggah Berkas Pasien (KTP) <small class="text-danger">*Max 2MB</small></h4>
